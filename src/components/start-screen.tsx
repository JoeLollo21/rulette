  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center p-12 gap-8">
      ...
      <div className="text-center">
        <h1 className="font-headline text-5xl lg:text-7xl tracking-wider">RULETTE</h1>
        <p className="text-lg text-muted-foreground mt-2">
          Created by <a href="https://joelollo21.github.io" target="_blank" rel="noopener noreferrer" className="underline hover:text-primary">Joe Lollo</a>, using TypeScript code (for the wheel) from <a href="https://github.com/jeffreylsoffer" target="_blank" rel="noopener noreferrer" className="underline hover:text-primary">Jeffrey Soffer</a> on Vercel.
        </p>
        <p className="text-lg text-muted-foreground mt-2">
          Based on <a href="https://www.dropout.tv" target="_blank" rel="noopener noreferrer" className="underline hover:text-primary">Dropout's</a> <a href="https://www.dropout.tv/videos/rulette" target="_blank" rel="noopener noreferrer" className="underline hover:text-primary"><i>Game Changer</i> episode</a> of the same name.
        </p>
        <div className="mt-2">
            <Dialog>
